...
if __name__ == '__main__':
    ...
    ap.add_argument("-f", "--foreground", type=str, required=True,
    ...
    filename1 = args["foreground"]
    filename2 = args["background"]
    ...
    points1 = read_points(filename1 + '.txt')
    points2 = read_points(filename2 + '.txt')
